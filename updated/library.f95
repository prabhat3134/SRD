...
! Grid Parameters
INTEGER, PARAMETER :: Ly = 50, Lx = 50, np = Ly*Lx*Gama, half_plane = 1
REAL(kind=dp), PARAMETER ::  alpha = pi/2.0d0, kbT = 1.0d0, dt_c =0.1d0
! Forcing 
REAL(kind=dp) :: avg=0.0d0, std=sqrt(kbT/(m*1.0d0)), f_b = 0.0d-4
! time values
INTEGER :: tmax=30000, t_avg = 500000, avg_interval=1, ensemble_num = 100000
! RGS, streaming
INTEGER :: random_grid_shift = 1, verlet = 1, grid_up_down
! Thermostat
INTEGER :: mb_scaling = 0, MC_scaling = 0, mbs_freq=50
...
! cylinder parameters
INTEGER :: obst = 0, grid_check(0:Ly+1,Lx)=0 
