...
if [ $# -gt 1 ]; then
	...
	gfortran -ffree-line-length-none -cpp -fopenmp -c SRD2D_gcc_library.f95 -fcheck=bounds
	gfortran -ffree-line-length-none -cpp -fopenmp -o SRD2D_par SRD2D_main.f95 SRD2D_gcc_library.o -fcheck=bounds
else
